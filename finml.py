...
class FinML(Indicators):
    ...
    def get_cumsum_events(self, raw_price, threshold):    #CUMSUM
        """
    ...
    def get_vertical_barrier(self, t_events, close, num_days=1, interval='d'):
        """
        ...
        """
        t1 = close.index.searchsorted(t_events + pd.Timedelta(num_days, interval))
        t1 = t1[t1 < close.shape[0]]
        t1 = pd.Series(close.index[t1], index=t_events[:t1.shape[0]])  # NaNs at end
        return t1
    
    def apply_pt_sl_on_t1(self, close, events, pt_sl, molecule):
        """
        :param close: (series) close prices
    ...
    def get_events(self, close, t_events, pt_sl, target, min_ret, num_threads, 
        ...
        df0 = MultiProcessingFunctions.mp_pandas_obj(func=self.apply_pt_sl_on_t1,
...
# =============================================================================
    ...
    def barrier_touched(self, out_df):
        """
    ...
    def get_bins(self, triple_barrier_events, close):
        ...
        out_df = self.barrier_touched(out_df)
